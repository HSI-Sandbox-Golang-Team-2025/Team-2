...
type Content struct {
	...
	VideoURL      string                        `json:"videoUrl" example:"https://example.com/" extensions:"x-order=07"`
	Type          ContentType                   `json:"type" gorm:"type:content_types" example:"practice" extensions:"x-order=08"`
	Order         uint                          `json:"order" example:"1" extensions:"x-order=09"`
	IsCompleted   bool                          `json:"isCompleted" gorm:"<-:false;-:migration" example:"false" extensions:"x-order=11"`
	Questions     *[]question.Question          `json:"questions" extensions:"x-order=10"`
